...
import helpers
from helpers import allow_registration,authorized,if_CEO
from common import add_player_if_not_existant, get_player_name, send_random_joke, send_abusive_comment, reply_registration_not_allowed, reply_to_unauthorized, add_player_if_not_existant_with_params, reply_no_player_found
import database
import constants
        ...
        if (allow_registration()):
            if (authorized(message.chat.id)):
                if player is not None:
                    ...
                    reply_no_player_found(bot, message, message.text)
            else:
