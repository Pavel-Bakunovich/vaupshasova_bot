...
async def execute(message, bot):
    try:
        ...
        if await validate_access_no_game_registration_needed(message.chat.id, current_player, bot, message):
            ...
            await bot.send_photo(message.chat.id, season_stats_photo, reply_to_message_id=message.message_id)
            
            alltime_personal_stats_photo = alltime_personal_stats(current_player)
            await bot.send_photo(message.chat.id, alltime_personal_stats_photo, reply_to_message_id=message.message_id)
            
            last_games_photo = last_games(current_player)
            await bot.send_photo(message.chat.id, last_games_photo, reply_to_message_id=message.message_id)
